...
Java Developer
Created on 15/07/2025 22:43
@Last Modified 15/07/2025 22:43
Version 1.0
*/
...
public class ProductRequest {
    @NotNull(message = "File foto wajib diunggah")
    private String photo; // Harus ditangani multipart di controller
